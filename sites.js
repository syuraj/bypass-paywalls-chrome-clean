var defaultSites = {
  ...
  "McClatchy Group (opt-in to custom sites for unlisted)": {
    ...
    block_regex: /(\.amplitude\.com\/|\.mcclatchy\.com\/mcc-paywall-new\.js|cdn\.ampproject\.org\/v\d\/amp-(access|subscriptions)-.+\.js)/
  },
  ...
  "Roularta Media Group": {
    ...
    allow_cookies: 1,
    block_js_inline: /\.(femmesdaujourdhui|flair|knack|levif|libelle)\.be\/.+\/(\w+-){2,}/,
 ...
 "Sport Life Ibérica (text only; opt-in to custom sites)": {
  ...
  "Piano.io (+ TinyPass)": {
    ...
    excluded_domains: ["piano.io", "auto-swiat.pl", "businessinsider.com.pl", "forbes.pl", "hbr.org", "japantimes.co.jp", "komputerswiat.pl", "nacion.com", "newsweek.pl", "onet.pl"]
  },
  "Pico.tools": {
    domain: "pico.tools",
    allow_cookies: 1,
...
var nofix_sites = ['11freunde.de', 'abplive.com', 'aftenposten.no', 'aftonbladet.se', 'al-monitor.com', 'allgaeuer-zeitung.de', 'americanscientist.org', 'arkansasonline.com', 'asahi.com', 'asiatimes.com', 'autocar.co.uk', 'aviationweek.com', 'badische-zeitung.de', 'bhaskar.com', 'bisnis.com', 'bloomberglaw.com', 'bloombergtax.com', 'bnef.com', 'borsen.dk', 'businessdesk.co.nz', 'businessinsider.de', 'businessinsider.jp', 'businesslive.co.za', 'businesstimes.com.sg', 'caixin.com', 'caixinglobal.com', 'capital.de', 'caravanmagazine.in', 'catalyst-journal.com', 'chegg.com', 'cieletespace.fr', 'citywire.com', 'consumerreports.org', 'costar.com', 'coursehero.com', 'crunchbase.com', 'dealstreetasia.com', 'delfi.ee', 'denikn.cz', 'deraktionaer.de', 'deutsche-wirtschafts-nachrichten.de', 'die-glocke.de', 'diepresse.com', 'document.no', 'donaukurier.de', 'elordenmundial.com', 'endpts.com', 'entrepreneur.com', 'epw.in', 'euractiv.com', 'ewmagazine.nl', 'falter.at', 'finance.si', 'franc-tireur.fr', 'freiepresse.de', 'ftchinese.com', 'ftchineselive.com', 'gamestar.de', 'gazetaprawna.pl', 'gazeteoksijen.com', 'gelocal.it', 'geo.de', 'gp.se', 'hbrarabic.com', 'hbr-caijing.com', 'hbrfrance.fr', 'hedgehogreview.com', 'hindutamil.in', 'history.org.uk', 'hsj.co.uk', 'humanite.fr', 'iex.nl', 'ifre.com', 'ilmanifesto.it', 'information.dk', 'investors.com', 'iltalehti.fi', 'investing.com', 'jacobin.com', 'janes.com', 'jn.pt', 'jungefreiheit.de', 'kicker.de', 'kleinezeitung.at', 'kommunen.dk', 'krone.at', 'laprovence.com', 'laverita.info', 'lavie.fr', 'lavozdegalicia.es', 'law360.ca', 'law360.co.uk', 'law360.com', 'lecanardenchaine.fr', 'leconomiste.com', 'ledesk.ma', 'lefigaro.fr', 'lefilmfrancais.com', 'lemonde.fr', 'lemoniteur.fr', 'lequipe.fr', 'lesjours.fr', 'letemps.ch', 'libertiesjournal.com', 'lindipendente.online', 'lorientlejour.com', 'lr-online.de', 'mailplus.co.uk', 'main-echo.de', 'mainpost.de', 'malaysiakini.com', 'marianne.net', 'maville.com', 'mediapart.fr', 'milanofinanza.it', 'mittelbayerische.de', 'money.it', 'moneycontrol.com', 'moodys.com', 'morningstar.com', 'motorsport.com', 'moz.de', 'mz.de', 'nachrichten.at', 'naiz.eus', 'nationaljournal.com', 'nature.com', 'nbr.co.nz', 'newleftreview.org', 'news24.com', 'newscientist.com', 'newspapers.com', 'newsroom.co.nz', 'nexos.com.mx', 'nikkei.com', 'nn.de', 'nouvelobs.com', 'noz.de', 'ntnews.com.au', 'nypost.com', 'ojogo.pt', 'on3.com', 'onetz.de', 'ouest-france.fr', 'pagina12.com.ar', 'penews.com', 'pff.com', 'philonomist.com', 'pnp.de', 'politicopro.com', 'politiken.dk', 'postimees.ee', 'pressreader.com', 'publico.pt', 'rbc.ru', 'reason.com', 'reforma.com', 'republic.ru', 'risk.net', 'rnz.de', 'saechsische.de', 'saltwire.com', 'schwaebische.de', 'sciencedirect.com', 'shz.de', 'sn.at', 'springer.com', 'statnews.com', 'stimme.de', 'streetinsider.com', 'studocu.com', 'substack.com', 'svd.se', 'swp.de', 'table.media', 'taxation.co.uk', 'taxjournal.com', 'telerama.fr', 'the-ken.com', 'thebanker.com', 'theinformation.com', 'theinitium.com', 'thejakartapost.com', 'themorningcontext.com', 'theparisreview.org', 'thestar.com.my', 'timeslive.co.za', 'udn.com', 'usine-digitale.fr', 'vedomosti.ru', 'vi.nl', 'volksstimme.de', 'weltwoche.ch', 'weltwoche.de', 'wissenschaft.de', 'worldpoliticsreview.com', 'woz.ch', 'wpolityce.pl', 'wz.de', 'xakep.ru', 'zaobao.com.sg'].concat(custom_flex_nofix_domains, de_funke_medien_nofix_domains, de_westfalen_medien_nofix_domains, fi_sanoma_nofix_domains, fr_be_groupe_rossel_nofix_domains, fr_groupe_ebra_nofix_domains, fr_indigo_nofix_domains, fr_jamg_nofix_domains, fr_monde_diplo_nofix_domains, it_gedi_nofix_domains, se_bonnier_group_nofix_domains);
